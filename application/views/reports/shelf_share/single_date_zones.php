...
foreach ($components_zone as $zone => $componentBrand) {
    $sum_metrage_zone[$zone] = array_sum(array_values($componentBrand));
}
?>
            ...
            foreach ($clusters as $cluster) {
                ...
                <div class="portlet light ">
                    ...
                    <script type="text/javascript">
                        ...
                        jQuery.ajax({
                            url: "<?php echo site_url("reports/load_shelf_cluster_zones"); ?>",
                            data: {
        ...
        <div class="col-md-12">
            ...
            foreach ($selected_zone_ids as $zone_id) {
                ...
                <div class="portlet light ">
                    ...
                    <div  style ="height:900px" id="content_zone<?php echo $zone_id; ?>"> </div>


                    <script type="text/javascript">
                        $('#content_zone<?php echo $zone_id; ?>').html('<div class="col-md-12"><img src="<?php echo base_url('assets/img/ajax-loading.gif'); ?>" class="img-responsive img-center" /></div>');
                        jQuery.ajax({
                            url: "<?php echo site_url("reports/load_shelf_zone_pie_chart"); ?>",
                            data: {
                                start_date: "<?php echo $start_date; ?>",
                                end_date: "<?php echo $end_date; ?>",
                                category_id: "<?php echo $category_id; ?>",
