...
class Googlemaps {
    ...
    var $apiKey = 'AIzaSyDHuB62hGNykVD6L2axjCwu0KUPSBF1VBA';       // If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
    ...
    var $map_height = "900px";     // The height of the map container. Any units (ie 'px') can be used. If no units are provided 'px' will be presumed
