    ...
    <div class="col-md-12">
        ...
        <div class="portlet light">
            ...
            <div class="portlet-body form">
                ...
                <?php echo form_open('reports/pos_stock_issues_report', $attributes); ?>
                ...
                <div class="form-body">
                    ...
                    <div class="form-group" id="month">
                        ...
                        <div class="col-md-4">
                            <?php
                            $data = array('id' => 'datepicker_m1', 'class' => 'form-control');
                            echo form_input($data);
                            ?>
                            <input type="hidden" name="start_date_m"  id="datepicker_m1_alt" />		
                        </div>
                        ...
                        <div class="col-md-4">
                            <?php
                            $data = array('id' => 'datepicker_m2', 'class' => 'form-control');
                            echo form_input($data);
                            ?>
                            <input type="hidden" name="end_date_m"  id="datepicker_m2_alt" />		
                        </div>
                    </div>
                    ...
                    <div class="form-group" id="week">
                        ...
                        <div class="col-md-4">
                            <?php
                            $data = array('id' => 'datepicker_w1', 'class' => 'form-control');
                            echo form_input($data);
                            ?>
                            <input type="hidden" name="start_date_w"  id="datepicker_w1_alt" />		
                        </div>
                        ...
                        <div class="col-md-4">
                            <?php
                            $data = array('id' => 'datepicker_w2', 'class' => 'form-control');
                            echo form_input($data);
                            ?>
                            <input type="hidden" name="end_date_w"  id="datepicker_w2_alt" />		
                        </div>
                    </div>
    ...
    foreach ($categories as $category) {
        ...
        <div class="portlet light ">
            ...
            <script type="text/javascript">
                ...
                jQuery.ajax({
                    url: "<?php echo site_url("reports/load_pos_stock_issues_category"); ?>",
                    data: {
